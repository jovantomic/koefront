...
import ShowProduct from './ShowProductPage';
...
const PostContent = ({ data }) => {
  ...
  const closePopup = () => setPopupSrc(null);
    ...
    return (
        <div className="flex flex-col md:flex-row w-full h-auto p-8 bg-white shadow-lg lg:w-[80%] ">
            ...
            <div className="w-full md:w-2/3 flex flex-col p-4 md:p-8">
               ...
               <ShowProduct products={data.products}/>
               </div>
            {popupSrc && (
